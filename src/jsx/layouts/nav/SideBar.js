          ...
          <MM className="metismenu" id="menu">
            <li>
              <Link className="has-arrow ai-icon" to="#">
                ...
                <span className="nav-text">Panel główny</span>
              </Link>
              <ul>
                <li>
                  <Link
                ...
                <li>
                  <Link
                    className={`${
                      path === "workout-statistic" ? "mm-active" : ""
                    }`}
            ...
            <li className={`${forms.includes(path) ? "mm-active" : ""}`}>
              <Link className="has-arrow ai-icon" to="#">
                <i className="flaticon-381-controls-3"></i>
                <span className="nav-text forms">Klienci</span>
              </Link>
              <ul>
                <li>
                  <Link
            ...
            <li className={`${forms.includes(path) ? "mm-active" : ""}`}>
              <Link to="/add-customers" className="has-arrow ai-icon">
                <i className="flaticon-381-television"></i>
            ...
            <li className={`${forms.includes(path) ? "mm-active" : ""}`}>
              <Link to="/generate-training" className="has-arrow ai-icon">
                <i className="flaticon-381-internet"></i>
                <span className="nav-text forms">
                  Generator jednostki treningowej
                </span>
              </Link>
            </li>
            ...
            <li className={`${forms.includes(path) ? "mm-active" : ""}`}>
              <Link className="has-arrow ai-icon" to="#">
                <i className="flaticon-381-heart"></i>
                <span className="nav-text forms">Środki treningowe</span>
              </Link>
              <ul>
                <li>
                  <Link
                    ...
                    to="/resources"
                  >
                    Pokaż wszystkie środki treningowe
                  </Link>
                </li>
              </ul>
            </li>
            ...
            <li className={`${forms.includes(path) ? "mm-active" : ""}`}>
              <Link className="has-arrow ai-icon" to="#">
                ...
                <span className="nav-text forms">Kalendarz</span>
              </Link>
              <ul>
                <li>
                  <Link
            ...
            <li className={`${forms.includes(path) ? "mm-active" : ""}`}>
              <Link className="has-arrow ai-icon" to="#">
                ...
                <span className="nav-text forms">Trenerzy</span>
              </Link>
              <ul>
                <li>
                  <Link

      ...
      <div className="items">
        <div className="card text-center">
          <div className="card-body">
            ...
            <p className="fs-14">Trener kulturystyki</p>
      ...
      <div className="items">
        <div className="card text-center">
          <div className="card-body">
            ...
            <p className="fs-14">Trener grubego brzucha</p>
            <div className="d-flex align-items-center justify-content-center">
              <svg
                width={20}
                height={20}
      ...
      <div className="items">
        <div className="card text-center">
          <div className="card-body">
            ...
            <p className="fs-14">Trener szcześciopaka</p>
            <div className="d-flex align-items-center justify-content-center">
              <svg
                width={20}
                height={20}
      ...
      <div className="items">
        <div className="card text-center">
          <div className="card-body">
            ...
            <p className="fs-14">Trener Ciała</p>
            <div className="d-flex align-items-center justify-content-center">
              <svg
                width={20}
                height={20}

        ...
        <div className="card">
          <div className="card-header pb-0 border-0">
            ...
            <div className="mr-auto pr-3">
              <h4 className="text-black fs-20">Bieganie</h4>
      ...
      <div className="col-xl-4 col-lg-6">
        <div className="card">
          <div className="card-header pb-0 border-0">
            ...
            <div className="mr-auto pr-3">
              <h4 className="text-black fs-20">Jazda na rowerze</h4>
              <p className="fs-13 mb-0 text-black">
                Lorem ipsum dolor sit amet, consectetur
              </p>
            </div>
      ...
      <div className="col-xl-4">
        <div className="card">
          <div className="card-header pb-0 border-0">
            ...
            <div className="mr-auto pr-3">
              <h4 className="text-black fs-20">Trening Yogi</h4>
              <p className="fs-13 mb-0 text-black">
                Lorem ipsum dolor sit amet, consectetur
              </p>
            </div>
          ...
          <div className="col-xl-12">
            <div className="card">
              <div className="card-header border-0 pb-0">
                <h4 className="text-black fs-20 mb-0">Wykresy</h4>
              </div>
              <div className="card-body text-center">
                ...
                <ul className="d-flex flex-wrap">
                  <li className="mr-5 mb-2">
                    ...
                    <span className="fs-12 text-black">Niebieski kolor</span>
                  </li>
                  <li className="mr-5 mb-2">
                    <svg
                      className="mr-2"
                    ...
                    <span className="fs-12 text-black">Pomarańczony kolor</span>
                  </li>
                  <li className="mr-5 mb-2">
                    <svg
                      className="mr-2"
                    ...
                    <span className="fs-12 text-black">Szary kolor</span>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="col-xl-12">
            <div className="card">
              <div className="card-header flex-wrap border-0 pb-0">
                <h4 className="text-black fs-20 mb-3">Postęp</h4>
                <Link
                  ...
                  <div className="col-lg-8">
                    <div className="row">
                      <div className="col-sm-6">
                        <div className="d-flex align-items-center mb-sm-5 mb-3">
                          <div className="d-inline-block relative donut-chart-sale mr-3">
                            <Donut backgroundColor="#A02CFA" value={45} />
                            <small>
                              <svg
                                width={24}
                                height={24}
                          ...
                          <div>
                            <h4 className="fs-18 text-black">Bieganie (45%)</h4>
                      ...
                      <div className="col-sm-6">
                        <div className="d-flex align-items-center mb-sm-5 mb-3">
                          <div className="d-inline-block relative donut-chart-sale mr-3">
                            <Donut backgroundColor="#FFBC11" value={78} />
                            <small>
                              <svg
                                width={24}
                                height={24}
                      ...
                      <div className="col-sm-6">
                        <div className="d-flex align-items-center mb-sm-0 mb-3">
                          <div className="d-inline-block relative donut-chart-sale mr-3">
                            <Donut backgroundColor="#FF3282" value={66} />
                            <small>
                              <svg
                                width={24}
                                height={24}
                      ...
                      <div className="col-sm-6">
                        <div className="d-flex align-items-center mb-sm-0 mb-3">
                          <div className="d-inline-block relative donut-chart-sale mr-3">
                            <Donut backgroundColor="#82BE65" value={90} />
                            <small>
                              <svg
                                width={24}
                                height={24}

    ...
    <div className="row">
        ...
        <div className="card">
          <div className="card-body">
            <div className="row align-items-center">
              <div className="col-xl-5 col-xxl-12 mr-auto">
                <div className="d-sm-flex d-block align-items-center">
                  <img src={illustration} alt="" className="mw-100 mr-3" />
                  <div>
              ...
              <div className="col-xl-7 col-xxl-12 mt-3">
                ...
                >
                  May 28th, 2020
                  <i className="las la-calendar ml-3 scale5" />
                </Link>
                <svg
                  className="ml-2 mr-2"
                  width={14}
                ...
                <Link
                  to="workoutplan"
                  className="btn btn-outline-primary mr-3 btn-md  mb-2"
                >
                  June 28th, 2020
                  <i className="las la-calendar ml-3 scale5" />
                </Link>
                <Link to="workoutplan" className="btn btn-primary btn-md mb-2">
                  Generate Report
                  <i className="las la-angle-right ml-3 scale5" />
                </Link>
              </div>
            </div>
          </div>
        ...
        <div className="card">
          <div className="card-header bg-white">
            <div className="d-flex mr-3 align-items-center">
              <span className="p-sm-3 p-2 mr-sm-3 mr-2 rounded-circle bg-secondary">
                <svg
                  width={32}
                  height={32}
                  viewBox="0 0 32 32"
            ...
            <div className="table-responsive">
              <table className="table shadow-hover">
                ...
                <tbody>
                  <tr>
                    <td>
                      <p className="text-black mb-1 font-w600">Sunday</p>
                      <span className="fs-14">September 2, 2020</span>
                    </td>
                    <td>
                      <p className="text-black mb-1 font-w600">14,2 Km</p>
                      <span className="fs-14">Target 15Km</span>
                    </td>
                    <td>
                      <p className="text-black mb-1 font-w600">00:53:22”</p>
                      <span className="fs-14">Target 40mins</span>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <p className="text-black mb-1 font-w600">Monday</p>
                      <span className="fs-14">September 3, 2020</span>
                    </td>
                    <td>
                      <p className="text-black mb-1 font-w600">14,2 Km</p>
                      <span className="fs-14">Target 15Km</span>
                  ...
                  <tr>
                    <td>
                      <p className="text-black mb-1 font-w600">Tuesday</p>
                      <span className="fs-14">September 4, 2020</span>
                    </td>
                    <td>
                      <p className="text-black mb-1 font-w600">14,2 Km</p>
                      <span className="fs-14">Target 15Km</span>
                  ...
                  <tr>
                    <td>
                      <p className="text-black mb-1 font-w600">Wednesday</p>
                      <span className="fs-14">September 5, 2020</span>
                    </td>
                    <td>
                      <p className="text-black mb-1 font-w600">14,2 Km</p>
                      <span className="fs-14">Target 15Km</span>
                  ...
                  <tr>
                    <td>
                      <p className="text-black mb-1 font-w600">Thursday</p>
                      <span className="fs-14">September 8, 2020</span>
                    </td>
                    <td>
                      <p className="text-black mb-1 font-w600">14,2 Km</p>
                      <span className="fs-14">Target 15Km</span>
                  ...
                  <tr>
                    <td>
                      <p className="text-black mb-1 font-w600">Friday</p>
                      <span className="fs-14">September 7, 2020</span>
                    </td>
                    <td>
                      <p className="text-black mb-1 font-w600">14,2 Km</p>
                      <span className="fs-14">Target 15Km</span>
                  ...
                  <tr>
                    <td>
                      <p className="text-black mb-1 font-w600">Saturday</p>
                      <span className="fs-14">September 8, 2020</span>
                    </td>
                    <td>
                      <p className="text-black mb-1 font-w600">14,2 Km</p>
                  ...
                  <tr>
                    <td>
                      <p className="text-black mb-1 font-w600">Sunday</p>
                      <span className="fs-14">September 9, 2020</span>
                    </td>
                    <td>
                      <p className="text-black mb-1 font-w600">14,2 Km</p>
                      <span className="fs-14">Target 15Km</span>
      ...
      <div className="col-xl-4 col-xxl-6 col-lg-6">
        <div className="card">
          <div className="card-header bg-white">
            <div className="d-flex mr-3 align-items-center">
              <span className="p-sm-3 p-2 mr-sm-3 mr-2 rounded-circle bg-danger">
                <svg
                  width={32}
                  height={32}
                  viewBox="0 0 30 30"
        ...
        <div className="card">
          <div className="card-header bg-white">
            <div className="d-flex align-items-center mr-3">
              <span className="p-sm-3 p-2 mr-sm-3 mr-2 rounded-circle bg-warning">
                <svg
                  width={32}
                  height={32}
                  viewBox="0 0 30 30"

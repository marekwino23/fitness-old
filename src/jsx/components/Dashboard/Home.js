              ...
              <div className="card-body">
                <div className="media align-items-center">
                  ...
                  <div className="media-body">
                    <p className="fs-14 mb-2">Ilość treningów w miesiącu</p>
                    <span className="title text-black font-w600">120</span>
                  </div>
                </div>
                <div className="progress" style={{ height: 5 }}>
                  <div
                    ...
                    role="progressbar"
                  >
                    <span className="sr-only">42% Zakończone</span>
                  </div>
                </div>
              </div>
            ...
            <div className="card avtivity-card">
              <div className="card-body">
                <div className="media align-items-center">
                  ...
                  <div className="media-body">
                    <p className="fs-14 mb-2">Ilosć sprzedanych karnetów</p>
            ...
            <div className="card avtivity-card">
              <div className="card-body">
                <div className="media align-items-center">
                  ...
                  <div className="media-body">
                    <p className="fs-14 mb-2">Ilość klientów</p>
                    <span className="title text-black font-w600">60</span>
                  </div>
                </div>
                <div className="progress" style={{ height: 5 }}>
                  <div
                ...
                <div className="media align-items-center">
                  ...
                  <div className="media-body">
                    <p className="fs-14 mb-2">
                      Ilość godzin przepracowanych przez trenerów
                    </p>
                    <span className="title text-black font-w600">72</span>
                  </div>
                </div>
                <div className="progress" style={{ height: 5 }}>
                  <div

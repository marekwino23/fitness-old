...
const DistanceMap = () => {
  const [refreashToggle, setRefreashToggle] = useState(false);
  return (
    <div className="row">
          ...
          <div className="col-xl-12">
            <div className="card">
              <div className="card-header d-md-flex d-block pb-0 border-0">
                <div className="mr-2 mb-md-0 mb-3">
                  <h4 className="text-black fs-20">Trasy na mapach</h4>
              ...
              <Tab.Container defaultActiveKey="Running">
                <div className="card-header d-sm-flex d-block pb-0 border-0">
                  <div className="mr-auto pr-3">
                    <h4 className="text-black fs-20">Statystyki</h4>
                    <p className="fs-13 mb-0">
                      Lorem ipsum dolor sit amet, consectetur
                    </p>
                  </div>
          ...
          <div className="col-xl-12 col-md-6">
            <div className="card">
              <div className="card-header border-0 pb-0 p-4">
                <div>
                  <h4 className="text-black fs-20">Szczegóły treningu</h4>
                  <p className="fs-13 mb-0">
                    Lorem ipsum dolor sit amet, consectetur
                  </p>
                </div>
              ...
              <div className="card-body p-0">
                <div className="d-flex align-items-center bgl-primary p-4">
                  ...
                  <div>
                    <h6 className="fs-16 text-black mb-0">Jazda na rowerze</h6>
                    <span className="fs-12">100km cel/dzień</span>
                  </div>
                </div>
                <div className="d-flex flex-wrap p-4">
                  <div className="mr-5 mb-3">
                    <p className="fs-14 mb-2">Całkowity dystans</p>
                    <span className="fs-20 font-w500 text-black">24km</span>
                  </div>
                  <div className="mr-5 mb-3">
                    <p className="fs-14 mb-2">Czas</p>
                    <span className="fs-20 font-w500 text-black">00:34:53</span>
                  </div>
                  <div className="mr-5 mb-3">
                    <p className="fs-14 mb-2">Czas rozpoczęcia</p>
                    <span className="fs-20 font-w500 text-black">09:22</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="col-xl-12 col-md-6">
            <div className="card">
              <div className="card-header d-sm-flex d-block border-0">
                <div className="mr-auto pr-3">
                  <h4 className="text-black fs-20">Ostatnie aktywności</h4>
                  <p className="fs-13 mb-0">
                    Lorem ipsum dolor sit amet, consectetur
                  </p>
                </div>
              ...
              >
                <div className="d-flex py-3 border-bottom align-items-center">
                  <span className="activity-icon bg-secondary mr-3">
                    <svg
                      width={24}
                      height={24}
                      viewBox="0 0 24 24"
                  ...
                  <div>
                    ...
                    <span className="fs-12">2km dystansu</span>
                  </div>
                ...
                <div className="d-flex py-3 border-bottom align-items-center">
                  <span className="activity-icon bg-danger mr-3">
                    <svg
                      width={24}
                      height={24}
                      viewBox="0 0 24 24"
              ...
              <div className="card-footer style-1 text-center border-0 pt-0 pb-4">
                <Link
                  ...
                  onClick={() => setRefreashToggle(!refreashToggle)}
                >
                  {" "}
                  {refreashToggle && <i className="fa fa-refresh"></i>}
                </Link>
              </div>
            </div>
          </div>

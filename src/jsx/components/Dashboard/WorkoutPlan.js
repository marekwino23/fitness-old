                    ...
                    >
                      <div className="d-flex border-bottom flex-wrap pt-3 list-row align-items-center mb-2">
                        <div className="col-xl-5 col-xxl-8 col-lg-6 col-sm-8 d-flex align-items-center">
                          <div className="list-icon bgl-primary mr-3 mb-3">
                            <p className="fs-24 text-primary mb-0 mt-2">4</p>
                            <span className="fs-14 text-primary">Pon</span>
                          </div>
                          <div className="info mb-3">
                            <h4 className="fs-20 ">
                              ...
                              >
                                Rutynowy trening na spalanie tłuszczu
                              </Link>
                            </h4>
                        ...
                        <div className="col-xl-2 col-xxl-4 col-lg-2 col-sm-4 activities mb-3 mr-auto pl-3 pr-3 text-sm-center">
                          ...
                          <span className="text-warning ml-2">Bieganie</span>
                        </div>
                        <div className="col-xl-5 col-xxl-12 col-lg-4 col-sm-12 d-flex align-items-center">
                          <Link
                            to="/workoutplan"
                            className="btn mb-3 play-button rounded mr-3"
                          >
                      ...
                      <div className="d-flex border-bottom flex-wrap pt-3 list-row align-items-center mb-2">
                        <div className="col-xl-5 col-xxl-8 col-lg-6 col-sm-8 d-flex align-items-center">
                          <div className="list-icon bgl-primary mr-3 mb-3">
                            ...
                            <span className="fs-14 text-primary">Wt</span>
                          </div>
                          <div className="info mb-3">
                            <h4 className="fs-20 ">
                              <Link
                        ...
                        <div className="col-xl-2 col-xxl-4 col-lg-2 col-sm-4 activities mb-3 mr-auto pl-3 pr-3 text-sm-center">
                          ...
                          <span className="text-secondary ml-2">Yoga</span>
                        </div>
                        <div className="col-xl-5 col-xxl-12 col-lg-4 col-sm-12 d-flex align-items-center">
                          <Link
                            to="/workoutplan"
                      ...
                      <div className="d-flex border-bottom flex-wrap pt-3 list-row align-items-center mb-2">
                        <div className="col-xl-5 col-xxl-8 col-lg-6 col-sm-8 d-flex align-items-center">
                          <div className="list-icon bgl-primary mr-3 mb-3">
                            ...
                            <span className="fs-14 text-primary">Nie</span>
                          </div>
                          <div className="info mb-3">
                            <h4 className="fs-20 ">
                              <Link
                                ...
                                className="text-black"
                              >
                                Rutynowy trening cardio na spalanie
                              </Link>
                            </h4>
                            <span className="text-danger font-w600">
                              Niedokończony
                          ...
                          <div className="info mb-3">
                            <h4 className="fs-20 ">
                              <Link
                                ...
                                className="text-black"
                              >
                                Cotygodniowa rutynowa jazda na rowerze
                              </Link>
                            </h4>
                          ...
                          <div className="info mb-3">
                            <h4 className="fs-20 ">
                              <Link
                                ...
                                className="text-black"
                              >
                                Trening wydarzenia dla biegaczy 2020
                              </Link>
                            </h4>
                            <span className="text-primary font-w600">
                              Ukończono
                      ...
                      <div className="d-flex flex-wrap pt-3 list-row align-items-center">
                        <div className="col-xl-5 col-xxl-7 col-lg-6 col-sm-7 d-flex align-items-center">
                          <div className="list-icon bg-light mr-3 mb-3">
                            <p className="fs-24 text-black mb-0 mt-2">18</p>
                            <span className="fs-14 text-black">Sob</span>
                          </div>
                          <div className="info mb-3">
                            <h4 className="fs-20 ">
                              <Link
                ...
                <div className="card-body">
                  ...
                  <div className="d-flex mb-4 align-items-center">
                    ...
                    <div>
                      ...
                      <span>12 zestawów | 16 minut</span>
                    </div>
                  </div>
                  <div className="d-flex mb-4 align-items-center">
                    ...
                    <div>
                      ...
                      <span>Odległości docelowe 20km</span>
                    </div>
                  </div>
                  <div className="d-flex mb-4 align-items-center">

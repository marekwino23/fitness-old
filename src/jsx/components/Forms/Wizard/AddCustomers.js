    ...
    >
      ...
      <div className="row">
        <form className="customers-form" onSubmit={handleSubmit(saveForm)}>
          ...
          <input
            type="submit"
            value="Dodaj klienta i wygeneruj indywidualny 12 tygodniowy plan treningowy"
            style={{ padding: "10px", fontSize: "10px", height: "35px" }}
